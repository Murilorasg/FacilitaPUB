...
<body class="cadastro">
    ...
    <p class="tracking">Alteração de Empresa</p>
    <form action="./altera_empresa2.php" method="post" id="form_cadastro_empresa">
    <input type="text" name="id" value=<?php echo $info['id'] ?> hidden>
        <p><input type="text" name="razao_social" id="razao_social" placeholder="Razão Social" size="50" maxlength="50"></p>
        <p><input type="text" name="nome_fantasia" id="nome_fantasia" size="50" placeholder="Nome Fantasia" maxlength="50"></p>
    ...
    <footer>
        <a href="./cadastro_empresa_alterar.php"><img src="../images/icon_back.png" alt="Icone de voltar" class="icon_voltar"></a>
    </footer>
