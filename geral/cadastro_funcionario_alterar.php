...
<body>
    <header class="header_altcadastro">
        <p class="tracking"><a href="./menu_cad_gerais.php">Cadastros</a> > <a href="./cadastro_funcionario.php">Funcionário </a> > Alterar Cadastro</p>
    </header>
