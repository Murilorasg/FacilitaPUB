<?php
    ...
    (empty($_POST['ie'])) || (empty($_POST['endereco'])) || (empty($_POST['telefone']))){
        header('Location: ./cadastro_empresa_novo.php');
        exit();
    }
    ...
    $query = "INSERT INTO empresa (cnpj, razao_social, nome_fantasia, ie, endereco, telefone, situacao) 
