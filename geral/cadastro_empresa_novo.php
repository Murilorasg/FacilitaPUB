...
<body class="cadastro">
    ...
    <p class="tracking"><a href="./menu_cad_gerais.php">Cadastros</a> > <a href="./cadastro_empresa.php">Empresa </a> > Cadastrar Novo</p>
    <form action="./cadastra_empresa.php" method="post" id="form_cadastro_empresa">
    ...
    <?php
          if(isset($_SESSION['inclusao_empresa'])):
            ?>
            <p class='resultado'>Cadastro efetuado com sucesso</p>
            <?php
            endif;
            unset($_SESSION['inclusao_empresa']);
        ?>
</div>
</div>
    <footer>
