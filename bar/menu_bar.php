...
<head>
    ...
    <title>FacilitaPUB - Menu Bar</title>
</head>
<body>
<div class="acerta_altura2">
    <img src="../images/FacilitaPUB_Logo.png" alt="logo FacilitaPUB" class="logo_fpub">
    <p class="tracking">Menu Bar</p>
        <section class="menu">
         <div class="menu_buttons">
             <p><input type="button" value="Módulo Bar" class="buttons" onclick="window.location.href='./bar.php'"></p>
         </div>
         <div class="menu_buttons">
             <p><input type="button" value="Movimentar Barril" class="buttons" onclick="window.location.href='./movimentar_barril.php'"></p>
         </div>
