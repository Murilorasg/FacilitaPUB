...
<body class="cadastro">
    ...
    <p class="tracking"><a href="./menu_cad_estoque.php">Cadastros</a> > <a href="./cadastro_produto.php">Produto </a> > Cadastrar Novo</p>
    <form action="./cadastra_produto.php" method="post" id="form_cadastro_produto"><p>
        ...
        <p><select name="unidade" id="unidade">
            ...
            <option value="Unidade">Unidade</option></select>
    ...
    <footer>
        <a href="./cadastro_produto.php"><img src="../images/icon_back.png" alt="Icone de voltar" class="icon_voltar"></a>
    </footer>
</body>
</html>