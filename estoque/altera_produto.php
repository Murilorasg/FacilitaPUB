...
<body class="cadastro">
    ...
    <form action="./altera_produto2.php" method="post" id="form_cadastro_produto"><p>
    ...
    <footer>
        <a href="./cadastro_produto_alterar.php"><img src="../images/icon_back.png" alt="Icone de voltar" class="icon_voltar"></a>
    </footer>
