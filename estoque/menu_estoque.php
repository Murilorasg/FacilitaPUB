...
<head>
    ...
    <title>FacilitaPUB - Menu Estoque</title>
</head>
<body>
<div class="acerta_altura2">
    <img src="../images/FacilitaPUB_Logo.png" alt="logo FacilitaPUB" class="logo_fpub">
    <p class="tracking">Menu Estoque</p>
        <section class="menu">
         <div class="menu_buttons">
             <p><input type="button" value="Cadastros" class="buttons" onclick="window.location.href='./menu_cad_estoque.php'"></p>
         </div>
         <div class="menu_buttons">
             <p><input type="button" value="Lançar estoque" class="buttons" onclick="window.location.href='./lancamentos_estoque.php'"></p>
         </div>
         <div class="menu_buttons">
            <p><input type="button" value="Relatórios" class="buttons" onclick="window.location.href='./relatorios_estoque.php'"></p>
         </div>
        </section>
        </div>
     <footer>
