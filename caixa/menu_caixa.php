...
<head>
    ...
    <title>FacilitaPUB - Menu Caixa</title>
</head>
<body>
<div class="acerta_altura2">
    <img src="../images/FacilitaPUB_Logo.png" alt="logo FacilitaPUB" class="logo_fpub">
    <p class="tracking">Menu Caixa</p>
        <section class="menu">
         <div class="menu_buttons">
             <p><input type="button" value="Módulo Caixa" class="buttons" onclick="window.location.href='./caixa.php'"></p>
         </div>
         <div class="menu_buttons">
            <p><input type="button" value="Relatórios" class="buttons" onclick="window.location.href='./relatorios_caixa.php'"></p>
         </div>
        </section>
        </div>
     <footer>
