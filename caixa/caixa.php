...
<body>
    ...
    <div class="nome_produto">
        ...
        <table>
            ...
            <tr>
                <td><input type="text" name="quantidade" id="input_quantidade" onblur="inclui_produto()" size="10" maxlength="2" style="outline: 0; text-align: center;"
    ...
    <script type="text/javascript">
        ...
        function total_comanda(){
            ...
            if (isNaN(desconto)){
                document.getElementById('input_totalcomanda').value = valor.toLocaleString('pt-BR', { style: 'decimal'});
        } else{
            var resultado = parseFloat(valor-desconto);
            if (resultado < 0){
                alert("O desconto nao deve ser maior que o valor total da comanda")
                document.getElementById('input_totalcomanda').value = valor.toLocaleString('pt-BR', { style: 'decimal'});
            }else{
            document.getElementById('input_totalcomanda').value = resultado.toLocaleString('pt-BR', { style: 'decimal'});
;
        }
        }
        }
