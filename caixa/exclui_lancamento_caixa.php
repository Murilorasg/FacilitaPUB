...
if (isset($_GET['id'])) {
    ...
    $quant_lancamento = $data['quantidade'];
    ...
    if($barril!=NULL){
    $query = "UPDATE numeracao_barril SET quantidade = quantidade + ($quantidade*$quant_lancamento) WHERE barril='$barril' AND torneiras != 'NULL' LIMIT 1";
    $result = $conn->query($query);
    }
