...
WHERE LANCAMENTOS.comanda = '$comanda' AND LANCAMENTOS.situacao = '1' AND LANCAMENTOS.pago = '0'";
            ...
            ?>
<?php
                $nome_produto = filter_input(INPUT_GET, 'nome', FILTER_SANITIZE_SPECIAL_CHARS);
                $comanda = filter_input(INPUT_GET, 'id', FILTER_SANITIZE_SPECIAL_CHARS);

                if ((isset($nome_produto))&&(isset($comanda))){ 

                    $query = "SELECT * FROM produto WHERE nome LIKE '%$nome_produto%' AND situacao = '1'";
   ...
   if((isset($cod_produto))&&(isset($usuario))&&(isset($quantidade))){
    ...
    &&(isset($data))&&(isset($_SESSION['caixa']))){
        ...
        ";
            ...
            $barril = $data['barril'];
            $qnt_copo = $data['quantidade'];

            if($barril!=NULL){
                $query = "UPDATE numeracao_barril SET quantidade = quantidade - ($quantidade*$qnt_copo) WHERE barril='$barril' AND torneiras != 'NULL' LIMIT 1";
                $result = $conn->query($query);
            }
...
<body>
    ...
    <tr>
        ...
        if(isset($comanda)){echo $comanda;} ?>"  onblur="apresentar_comanda()" size="3" maxlength="3"></td>
    </tr>
    </table>
    </div>
    ...
    <div class="codigo">
        ...
        if(isset($codigo)){echo $codigo;} ?>" onblur="busca_codigo()" size="10" maxlength="10" style="outline: 0; text-align: center;"></td>
            </tr>
        </table>     
    </div>
    <div class="nome_produto">
        ...
        if(isset($nome)){echo $nome;} ?>" onblur="busca_nome()" size="60" maxlength="40" style="outline: 0; text-align: center;"></td>
            </tr>
        </table>
        </div>
    ...
    <script type="text/javascript">
        function apresentar_comanda(){
            let comanda = document.getElementById("input_comanda").value; 
            document.location.href="?id="+comanda
        }
        ...
        function busca_codigo(){
            ...
            let comanda = document.getElementById("input_comanda").value;
            document.location.href="?cod="+cod_produto+"&id="+comanda
        }

        function busca_nome(){
            let nome_produto = document.getElementById("input_nome").value; 
            let comanda = document.getElementById("input_comanda").value;
            document.location.href="?nome="+nome_produto+"&id="+comanda
        }
        ...
        function nome_usuario(){
         ...
         function aporte(){
            ...
            let prompt = parseFloat(window.prompt("Digite o valor do aporte: ", "0.00").replace(',', '.'));
         ...
         function sangria(){
            ...
            let turno = parseInt("<?php print $caixa_; ?>");
            let caixa_atual = parseInt("<?php print $caixa_atual; ?>");
